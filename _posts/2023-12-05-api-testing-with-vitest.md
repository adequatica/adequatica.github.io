...
- `beforeAll` contains `fetch()` HTTP request. `beforeAll` [must not contain any assertions](https://adequatica.github.io/2022/09/20/principles-of-writing-automated-tests.html). Response data and response body are stored in variables for subsequent checks;
